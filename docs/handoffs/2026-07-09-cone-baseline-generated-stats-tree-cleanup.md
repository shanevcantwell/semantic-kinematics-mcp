...
- **A clean NEGATIVE banked** — `ADR-SKM-0005`: deadpan/heller/jolt-magnitude falsified on
...
- **Generated-stats adopted** — `ADR-SKM-0006` + `scripts/summarize_corpus.py` →
...
- **4096-d nv-embed store: 99.71%** (86,748/87,004, **256 OOM-stuck** — tvi#43). This is the
  research substrate (ADR-SKM-0004). NOT cone-nulled or validated against the aims yet.
...
- Decisions: `ADR-SKM-0005` (falsification), `ADR-SKM-0006` (generated stats)
