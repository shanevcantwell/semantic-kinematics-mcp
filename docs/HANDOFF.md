...
**Git state:** `main` @ `cf82241` (#26 merged, stale branches pruned, remote = main only); ADR-0002 on `docs/adr-skmcp-0002` @ `c7f86d1` (PR #27). `spike_a_escalation_svd.py` + `.claude/` untracked on main.
