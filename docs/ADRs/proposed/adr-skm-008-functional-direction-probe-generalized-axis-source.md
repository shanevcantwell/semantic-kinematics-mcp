...
- **Downstream refinement (proposed, additive)** — [`ADR-SKM-009`](./adr-skm-009-funnel-measurement-profile.md) applies this functional-direction/calibration lineage to matched intervention populations, constituent-alignment matrices, and composition residuals. It refines and adds to this ADR; it neither supersedes ADR-SKM-008 nor implies acceptance of ADR-SKM-009.
